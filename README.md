...
```sh
pync [-4] [-6] [-b] [-C] [-D] [-d] [-e command] [-h] [-I length] [-k]
     [-l] [-O length] [-p source_port] [-q seconds] [-u] [-v] [-z]
     [dest] [port [port ...]]
```
</details>
...
```sh
py -m pync [-4] [-6] [-b] [-C] [-D] [-d] [-e command] [-h] [-I length] [-k]
           [-l] [-O length] [-p source_port] [-q seconds] [-u] [-v] [-z]
           [dest] [port [port ...]]
```
</details>
...
args = '''[-4] [-6] [-b] [-C] [-D] [-d] [-e command] [-h] [-I length] [-k]
          [-l] [-O length] [-p source_port] [-q seconds] [-u] [-v] [-z]
          [dest] [port [port ...]]'''
